...
class ChopperRecipe(ingredient: Ingredient, output: ItemStack, extraOutput: ItemStack, processingTime: Int) : DonkeyProcessingRecipe(ingredient, output, extraOutput, processingTime) {
